            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form class="forms-sample" action="/administrator/movies/<?php echo e($movie->id); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="title" placeholder="Title"
                                        name="title" value="<?php echo e($movie->title); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="poster" placeholder="Poster.png"
                                        name="poster" value="<?php echo e($movie->poster); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                    ...
                                    <select class="form-control" id="genres_id" name="genres_id">
                                        <?php $__currentLoopData = $genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>"
                                                <?php echo e($item->id == $movie->genres_id ? 'selected' : ''); ?>><?php echo e($item->name); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text" class="form-control" id="synopsis" placeholder="Synopsis" name="synopsis"
                                        value="<?php echo e($movie->synopsis); ?>"><?php echo e($movie->synopsis); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="release_date" placeholder="Release_date"
                                        name="release_date" value="<?php echo e($movie->release_date); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="countries_id" name="countries_id">
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>"
                                                <?php echo e($item->id == $movie->countries_id ? 'selected' : ''); ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="rating" placeholder="Rating"
                                        name="rating" value="<?php echo e($movie->rating); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('administrator.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/http/nitip/movieapp/bintang/resources/views/administrator/movies/edit.blade.php ENDPATH**/ ?>