...
@section('konten')
                ...
                <div class="slider-single-item">
                    ...
                    <div class="movie-item">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="mv-img-2">
                                    <a href="#"><img src="{{asset('landing_asset/images/uploads/poster1.jpg')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="slick-multiItem2">
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it1.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it2.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a href="moviesingle.html"> Read more <i
                                                        class="ion-android-arrow-dropright"></i> </a>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it3.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a href="moviesingle.html"> Read more <i
                                                        class="ion-android-arrow-dropright"></i> </a>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it4.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a href="moviesingle.html"> Read more <i
                                                        class="ion-android-arrow-dropright"></i> </a>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it5.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a href="moviesingle.html"> Read more <i
                                                        class="ion-android-arrow-dropright"></i> </a>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it6.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a href="moviesingle.html"> Read more <i
                                                        class="ion-android-arrow-dropright"></i> </a>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it7.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a href="moviesingle.html"> Read more <i
                                                        class="ion-android-arrow-dropright"></i> </a>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it8.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a href="moviesingle.html"> Read more <i
                                                        class="ion-android-arrow-dropright"></i> </a>
                            ...
                            <div class="row">
                                <div class="slick-multiItem2">
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('landing_asset/images/uploads/mv-it9.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a href="moviesingle.html"> Read more <i
                                                        class="ion-android-arrow-dropright"></i> </a>
                    ...
                    <div class="slider-nav-2 thumb-ft">
                        <div class="item">
                            <div class="trailer-img">
                                <img src="{{asset('landing_asset/images/uploads/trailer7.jpg')}}" alt="photo by Barn Images" width="4096"
                                    height="2737">
                            </div>
                        ...
                        <div class="item">
                            <div class="trailer-img">
                                <img src="{{asset('landing_asset/images/uploads/trailer2.jpg')}}" alt="photo by Barn Images" width="350"
                                    height="200">
                            </div>
                            <div class="trailer-infor">
                        ...
                        <div class="item">
                            <div class="trailer-img">
                                <img src="{{asset('landing_asset/images/uploads/trailer6.jpg')}}" alt="photo by Joshua Earle" width="509"
                                    height="301">
                            </div>
                            <div class="trailer-infor">
                        ...
                        <div class="item">
                            <div class="trailer-img">
                                <img src="{{asset('landing_asset/images/uploads/trailer3.png')}}" alt="photo by Alexander Dimitrov" width="100"
                                    height="56">
                            </div>
                            <div class="trailer-infor">
                        ...
                        <div class="item">
                            <div class="trailer-img">
                                <img src="{{asset('landing_asset/images/uploads/trailer4.png')}}" alt="photo by Wojciech Szaturski" width="100"
                                    height="56">
                            </div>
                            <div class="trailer-infor">
                        ...
                        <div class="item">
                            <div class="trailer-img">
                                <img src="{{asset('landing_asset/images/uploads/trailer5.jpg')}}" alt="photo by Wojciech Szaturski" width="360"
                                    height="189">
                            </div>
                            <div class="trailer-infor">
                ...
                <div class="sidebar">
                    <div class="celebrities">
                        ...
                        <div class="celeb-item">
                            <a href="#"><img src="{{asset('landing_asset/images/uploads/ava1.jpg')}}" alt="" width="70"
                                    height="70"></a>
                        ...
                        <div class="celeb-item">
                            <a href="#"><img src="{{asset('landing_asset/images/uploads/ava2.jpg')}}" alt="" width="70"
                                    height="70"></a>
                            <div class="celeb-author">
                        ...
                        <div class="celeb-item">
                            <a href="#"><img src="{{asset('landing_asset/images/uploads/ava3.jpg')}}" alt="" width="70"
                                    height="70"></a>
                            <div class="celeb-author">
                        ...
                        <div class="celeb-item">
                            <a href="#"><img src="{{asset('landing_asset/images/uploads/ava4.jpg')}}" alt="" width="70"
                                    height="70"></a>
                            <div class="celeb-author">
    ...
    <div class="latestnew full-width">
        <div class="row">
            <div class="col-md-12">
                <div class="ads adsv2">
                    <img src="{{asset('landing_asset/images/uploads/ads2.png')}}" alt="">
                </div>
                <div class="title-hd">
                    <h2>Latest news</h2>
                ...
                <div class="latestnewv2">
                    <div class="blog-item-style-2">
                        <a href="blogdetail.html"><img src="{{asset('landing_asset/images/uploads/blogv21.jpg')}}" alt=""></a>
                        <div class="blog-it-infor">
                            <h3><a href="blogdetail.html">Godzilla: King Of The Monsters Adds O’Shea Jackson Jr</a>
                            </h3>
                    ...
                    <div class="blog-item-style-2">
                        <a href="blogdetail.html"><img src="{{asset('landing_asset/images/uploads/blogv22.jpg')}}" alt=""></a>
                        <div class="blog-it-infor">
                            <h3><a href="blogdetail.html">First Official Images of Alicia Vikander As Tomb Raider’s
                                    Lara Croft</a></h3>
                            <span class="time">27 Mar 2017</span>
                    ...
                    <div class="blog-item-style-2">
                        <a href="blogdetail.html"><img src="{{asset('landing_asset/images/uploads/blogv23.jpg')}}" alt=""></a>
                        <div class="blog-it-infor">
                            <h3><a href="blogdetail.html">New Spider-Man: Homecoming Poster Finds Peter Parker At
                                    Rest</a></h3>
                            <span class="time">27 Mar 2017</span>
                    ...
                    <div class="blog-item-style-2">
                        <a href="blogdetail.html"><img src="{{asset('landing_asset/images/uploads/blogv24.jpg')}}" alt=""></a>
                        <div class="blog-it-infor">
                            <h3><a href="blogdetail.html">Joseph Gordon-Levitt Directing Moive Musical Comedy
                                    Wingmen</a></h3>
                            <span class="time">27 Mar 2017</span>
